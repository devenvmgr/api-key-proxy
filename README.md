...
[![CodeFactor](https://www.codefactor.io/repository/github/devenvmgr/api-key-proxy/badge)](https://www.codefactor.io/repository/github/devenvmgr/api-key-proxy)
...
```js
allowedDomains: ['https://www.mydomain.com', 'https://example.com']
```
...
Twitter: [@casjay\_](https://twitter.com/casjay_)
LinkedIn: [@casjay](https://www.linkedin.com/in/casjay)
